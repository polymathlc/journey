...
def segment_and_build(src_path, cell_size=(128, 128), out_filename="out.webp", skip_left=0, min_w=18, min_h=20, row_threshold=10, col_threshold=4, pad_bottom=8):
...
def package_all():
    ...
    segment_and_build(
        os.path.join(BRAIN_DIR, "bosses_pink_sheet_1786998590130.jpg"),
        cell_size=(160, 160),
        out_filename="infinite_bosses_b.webp",
        skip_left=0,
        pad_bottom=10
    )
